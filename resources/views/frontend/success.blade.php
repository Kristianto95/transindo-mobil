        ...
        <div class="container p-5  mb-5">
            <div class="row container mb-5">
                <div class="container p-4 mb-5 text-center">
                    <h2 class="fw-bold judul-section text-white">TERIMA KASIH ATAS PESANAN ANDA</h2>
                    <p class="text-white">silakan salin atau screenshoot kode transaksi anda untuk melakukan pengecekan
                    </p>
